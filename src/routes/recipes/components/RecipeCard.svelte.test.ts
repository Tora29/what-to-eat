...
describe('RecipeCard', () => {
	describe('imageUrl', () => {
		it('[SPEC: AC-001] imageUrl がない場合は外部画像 img 要素が表示されない（プレースホルダー表示）', async () => {
		...
		it('[SPEC: AC-001] imageUrl がある場合は img 要素が表示される', async () => {
